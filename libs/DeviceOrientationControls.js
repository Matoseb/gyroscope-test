...
var DeviceOrientationControls = function (object) {
  ...
  var onDeviceOrientationChangeEvent = (event) => {
    ...
    if (!this.hasOriented) {
      ...
      let oldOffset = this.alphaOffset;
      this.alphaOffset = -event.webkitCompassHeading || 0;

      if (oldOffset !== this.alphaOffset) {
        console.log("Orientation changed", oldOffset, this.alphaOffset);
